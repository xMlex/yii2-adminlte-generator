...
namespace xmlex\adminlte\generators\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            ['viewPath', 'safe'],
            [['name','elementName', 'elementNameAttribute'], 'safe'],
        ]);
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'name' => 'CRUD Name',
            'elementName' => 'One element Name',
            'elementNameAttribute' => 'Model attribute for element name',
        ]);
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'name' => 'CRUD Name, example: <code>Employees</code>',
            'elementName' => 'One element Name, example: <code>Employee</code>',
            'elementNameAttribute' => 'Model attribute for element name, example: <code>name</code> or <code>first_name</code>',
        ]);
    }
    ...
    {
        if(!empty($this->elementNameAttribute)){
            foreach ($this->getColumnNames() as $name) {
                if (!strcasecmp($name, $this->elementNameAttribute)) {
                    return $name;
                }
            }
            Yii::$app->session->addFlash('danger','Атрибут имени не найден: '.$this->elementNameAttribute);
        }
